...
\address{4B09, IT University of Copenhagen} % Your address
%\address{123 Pleasant Lane \\ City, State 12345} % Your secondary addess (optional)
\address{prdw@itu.dk \\ \href{https://www.prateekdwivedi.in/}{prateekdwivedi.in}} % Your phone number and email
...
\begin{rSection}{Research Interests}
  My research focuses on the theoretical foundations of computer science, with particular emphasis on \textbf{Algebraic Complexity Theory} and \textbf{Computational Complexity}.
\end{rSection}

\begin{rSection}{Employment}

  \item {\bf IT University of Copenhagen} \hfill {\em Copenhagen, Denmark} 
  \\ {Postdoctoral Researcher} \hfill {\em 2024 - }
  \\ Theoretical Computer Science Section
  \\ Adviser: \href{https://www.itu.dk/~nuli/}{Prof Nutan Limaye}
\end{rSection}
...
\begin{rSection}{Education}
  ...
  \\ {Doctor of Philosophy} \hfill {\em 2018 - 2025}
  \\ Computer Science and Engineering
  \\ Thesis: \emph{Treading the Borders for Explicitness, Circuit Factoring, and Identity Testing} [\href{https://www.prateekdwivedi.in/papers/thesis.pdf}{pdf}]
  \\ Adviser: \href{https://cse.iitk.ac.in/users/nitin/}{Prof Nitin Saxena}

  \item {\bf KCC Institute of Technology and Management} \hfill {\em Gautam Buddha Nagar, India} 
  \\ Bachelor of Technology\hfill {\em 2013 - 2017}
  \\ Computer Science and Engineering
...
\begin{rSection}{Publications}
    \item {\bf Lower Bounds in Algebraic Complexity via Symmetry and \\ Homomorphism Polynomials}\hfill \emph{2025}\\
    {with Benedikt Pago and Tim Seppelt}\\
    {\em Submitted, 2025}

    \item {\bf \href{https://arxiv.org/abs/2509.10725}{On Closure Properties of Read-Once Oblivious Algebraic Branching Programs}}\hfill \emph{2025}\\
    {with Robert Andrews, Jules Armand, Magnus Hansen, Nutan Limaye,\\ Srikanth Srinivasan, and Sébastien Tavenas}\\
    {\em 17th Innovations in Theoretical Computer Science (ITCS), 2026}

    \item {\bf \href{https://arxiv.org/abs/2506.19604}{A primer on the closure of algebraic complexity classes under factoring}}\hfill \emph{2025}\\
    {with C. S. Bhargav and Nitin Saxena}\\
    {\em To appear in the proceedings of Recent Trends in Computer Algebra (RTCA), 2025}

    \item {\bf \href{https://arxiv.org/abs/2505.22894}{Monotone bounded-depth complexity of homomorphism polynomials}}\hfill \emph{2024}\\
    {with C. S. Bhargav, Shiteng Chen, Radu Curticapean}\\
    {\em 50th International Symposium on Mathematical Foundations of Computer Science (MFCS), 2025}

    \item {\bf \href{https://www.prateekdwivedi.in/papers/PresentableVNP-confversion.pdf}{Learning the coefficients: A presentable version of border complexity\\ and applications to circuit factoring}}\hfill \emph{2024}\\
    {with C. S. Bhargav and Nitin Saxena}\\
    {\em 56th Annual ACM Symposium on Theory of Computing (STOC), 2024}
    
    \item {\bf \href{https://www.prateekdwivedi.in/papers/smABP-lowerbounds-confversion.pdf}{Lower bounds for the sum of small-size algebraic branching programs}}\hfill \emph{2024} \\
    {with C. S. Bhargav and Nitin Saxena}\\
    {\em 19th Annual Conference of Theory and Applications of Models of Computation (TAMC), 2024}\\
    {\em\color{highlight}Invited in the special issue of Theoretical Computer Science (Theor. Comput. Sci.)}
...
\begin{rSection}{Academic Talks and Seminars}
    \item {Non-Closure properties in algebraic complexity}\hfill {\em 2025}\\
    {\em IIT Delhi, India}

    \item {Monotone Bounded-Depth Complexity of Homomorphism Polynomials}\hfill {\em 2024}\\
    {\em ARCO, Malm\"{o} University, Sweden}

    \item {Presentable Version of Border Complexity and Applications to Circuit Factoring}
    \begin{itemize}
      \item {\em Ulm University, Germany}\hfill {\em 2024}
      \item {\em Welcome talk at the Theory Group, ITU, and BARC, KU} \hfill {\em 2024}
    \end{itemize}

    \item Treading the Border Complexity and Identity Testing Paradigms \hfill {\em 2022}
    \\ {\em Thesis Defense, IIT Kanpur}
...
%     Research EXPERIENCE
%-------------------------------------------
\begin{rSection}{Short Term Visits}
  \item 50th International Symposium on Mathematical Foundations of Computer Science (MFCS) \hfill {\em 2025}
  \\ {\em  Warsaw, Poland}

  \item 57th Annual ACM Symposium on Theory of Computing (STOC) \hfill {\em 2025}
  \\ {\em  Prague, Czech Republic}

  \item {Université Savoie Mont Blanc, France} \hfill {\em 2025}
  \\ {\em Host: Prof. S\'{e}bastien Tavenas}

  \item {Tata Institute of Fundamental Research (TIFR), Mumbai} \hfill {\em 2025}
  \\ {\em Host: Prof Mrinal Kumar}

  \item {Ulm University, Germany} \hfill {\em 2024}
  \\ {\em Host: Prof Thomas Thierauf}

  \item {Algorithmic Research-Cooperation around Oresund (ARCO)} \hfill {\em 2024}
  \\ {\em Malm\"{o} University, Sweden}
  ...
  \item{Chennai Mathematical Institute (CMI)} \hfill {\em 2022}
  \\ {\em Host: Prof Partha Mukhopadhyay}
...
\begin{rSection}{Academic Achievements}
    ...
    \\ {\em To attend an academic conference} 
    \item Ranked 23 in Joint Entrance Screening Test (JEST) \hfill {\em 2018}
    \item Ranked 1179 in Graduate Aptitude Test in Engineering (GATE) Computer Science \hfill {\em 2017} 
    \\ {\em Among approximately 1,00,000 candidates}
...
\begin{rSection}{Teaching and Mentoring Experience}
  \item \textbf{Undergraduate Project, ITU Copenhagen}\hfill {\em 2025}\\
  {\em Mentoring Th\o{}ger Bro and Emil Andreas Sondum Jointly with Prof Riko Jacob}
  \item \textbf{Head Tutor at CSE, IIT Kanpur}\\
  {\em Responsible for practical assignments, Lab Exam, and all the course-related logistical support}
  \begin{itemize}
    \item Data Structures and Algorithms \hfill {\em 2024}
  \end{itemize}

  \item \textbf{Mathematics for Computer Science, IIT Kanpur}\\
  {\em Adhyayan 2023, Summer School. Jointly with C. S. Bhargav}
...
\begin{rSection}{Professional Contributions}
  \item \textbf{Reviewer for Conferences}\\
  ...
  \item \textbf{Seminar Organiser at CSE, IIT Kanpur}\\
  {Regularly organise talks and seminars in a department special interest group (SIGTACS)}
\end{rSection}
...
\begin{rSection}{Personal Details}
  ...
  \item Contact \hfill +91 8800 291 032 \(|\) +45 31 81 36 18
\end{rSection}
...
\begin{rSection}{References}
  ...
  \begin{minipage}[t]{0.31\linewidth}
    \begin{center}
      \href{https://www.itu.dk/~nuli/}{Nutan Limaye} \\
      Professor \\
      ITU Copenhagen\\
      nuli@itu.dk
    \end{center}
